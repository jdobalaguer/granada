...
%                     struct('name','mt','convec',[ 1, 0, 0, 0, 0, 0, 0, 0, 0]) ...
%                     struct('name','e', 'convec',[ 0, 1, 0, 0, 0, 0, 0, 0, 0]) ...
%                     struct('name','v', 'convec',[ 0, 0, 1, 0, 0, 0, 0, 0, 0]) ...
%                     struct('name','w', 'convec',[ 0, 0, 0, 1, 0, 0, 0, 0, 0]) ...
%                     struct('name','u', 'convec',[ 0, 0, 0, 0, 1, 0, 0, 0, 0]) ...
%                     struct('name','r', 'convec',[ 0, 0, 0, 0, 0, 1, 0, 0, 0]) ...
%                     struct('name','mb','convec',[ 0, 0, 0, 0, 0, 0, 1, 0, 0]) ...
%                     struct('name','b', 'convec',[ 0, 0, 0, 0, 0, 0, 0, 1, 0]) ...
%                     struct('name','l', 'convec',[ 0, 0, 0, 0, 0, 0, 0, 0, 1]) ...
%                    };
    ...
    function build_regressors()
        ...
        for sub = u_subject
            ...
            for i_run = u_run
                ...
                z_std       = + data.vb_std(ii);
                z_value     = + data.resp_value(ii);
