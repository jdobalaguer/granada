...
if isempty(stecolor2),stecolor2='b';,end
if isempty(steshape),steshape='o';,end
if isempty(steline1),steline1=1;,end
if isempty(steline2),steline2=2;,end
...
%%% POINT %%%%%%%%
elseif plottype=='p';
plot(mx,'o','color','k','markerfacecolor',stecolor1,'markeredgecolor',stecolor1,'marker',steshape,'markersize',20);

%%% MIXED (i.e. POINTS WITH LINE) %%%%%%%%
elseif plottype=='m';
plot(mx,'o','color','k','markerfacecolor',stecolor1,'markeredgecolor',stecolor2,'marker',steshape,'markersize',20);
